...
//by hxw, do not chg, will leading to start fail 
#define MAX_SMC_CMD 30
				  ...
				  uint8_t flags)
{
	...
	struct smc_work work = {
		/* for hisi android compile issue: KTHREAD_WORK_INIT_ONSTACK */
