/*
 * Device driver for regulators in hi3798MV200 IC
 *
...
#define DRVNAME "hi3798mv2x-regulator"
...
struct hi3798mv2x_gpu_regulator {
...
static int hi3798mv2x_gpu_regulator_get_voltage(struct regulator_dev *regdev)
{
	struct hi3798mv2x_gpu_regulator *reg = rdev_get_drvdata(regdev);
	u32 duty, volt;
...
static int hi3798mv2x_gpu_regulator_set_voltage(struct regulator_dev *regdev,
...
static struct regulator_ops hi3798mv2x_gpu_regulator_ops = {
	.get_voltage = hi3798mv2x_gpu_regulator_get_voltage,
	.set_voltage = hi3798mv2x_gpu_regulator_set_voltage,
};

static int hi3798mv200_regulator_probe(struct platform_device *pdev)
{
	struct hi3798mv2x_gpu_regulator *reg;
	...
	reg->desc.ops = &hi3798mv2x_gpu_regulator_ops;
...
static const struct of_device_id hi3798mv200_regulator_of_match[] = {
	{ .compatible = "hisilicon,hi3798mv200-volt", },
	{ }
};

static struct platform_driver hi3798mv200_regulator_driver = {
	.probe = hi3798mv200_regulator_probe,
	.driver = {
		.name = DRVNAME,
		.owner = THIS_MODULE,
		.of_match_table = hi3798mv200_regulator_of_match,
	},
};

module_platform_driver(hi3798mv200_regulator_driver);

MODULE_AUTHOR("Hisilicon GPU Team");
MODULE_DESCRIPTION("hi3798mv200 regulator");
MODULE_LICENSE("GPLv2");
MODULE_ALIAS("platform:hi3798mv200-regulator");
